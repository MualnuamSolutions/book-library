		...
		<div class="row">
			<div class="col-sm-5">
				...
				<div class="add-book-option hidden">
					<!-- <div class="form-group">
						{{ Form::label('copies', 'Copies', array('class'=>'control-label col-lg-3')) }}
						<div class="col-lg-9">
							{{ Form::text('copies', '1', array('placeholder'=>'Copies', 'class'=>'form-control', 'id'=>'copies')) }}
						</div>
					</div>-->
					<div class="form-group">
		...
		<div class="row">
			<div class="col-sm-12">
				<table class="table book-list">
					...
					<tbody>
						<?php $books = Input::old('book'); $key = 0;?>
						@if(!empty($books))
