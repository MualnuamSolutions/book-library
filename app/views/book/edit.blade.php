			...
			<div class="col-lg-12 col-md-12">
				...
				<div class="panel panel-default">
					<div class="panel-heading">
						<h3 class="panel-title"><i class="fa fa-edit"></i> {{$book->title}}</h3>
					</div>
						...
						<div class="row">							
							<div class="col-lg-6 col-md-6">
								<div class="form-group {{($errors->has('title'))?'has-error':''}}">
									...
									<div class="col-sm-8">
										{{ Form::text('title', Input::old('title', $book->title), array('autocomplete'=>'off', 'id'=>'title', 'placeholder'=>'Enter title for the book', 'class'=>'form-control')) }}
