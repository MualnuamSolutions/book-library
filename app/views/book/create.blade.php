						...
						<div class="row">
							...
							<div class="col-lg-6 col-md-6">
								...
								<div class="form-group {{($errors->has('accession_no'))?'has-error':''}}">
									...
									<div class="col-sm-8">
										{{ Form::text('accession_no', Input::old('accession_no'), array('autocomplete'=>'off', 'id'=>'accession_no', 'placeholder'=>'', 'class'=>'form-control')) }}
								...
								<div class="form-group {{($errors->has('classification_no'))?'has-error':''}}">
									...
									<div class="col-sm-8">
										{{ Form::text('classification_no', Input::old('classification_no'), array('autocomplete'=>'off', 'id'=>'classification_no', 'placeholder'=>'Optional', 'class'=>'form-control')) }}
								...
								<div class="form-group {{($errors->has('copies'))?'has-error':''}}">
									...
									<div class="col-sm-8">
										{{ Form::text('copies', Input::old('copies'), array('autocomplete'=>'off', 'id'=>'copies', 'placeholder'=>'', 'class'=>'form-control')) }}
